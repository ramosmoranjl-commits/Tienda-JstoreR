Script
/* ==========================================================================
   JSTORER - LÓGICA INTEGRADA V24.0
   ========================================================================== */
...
    
    // Totales Paso 2
    const sub2 = document.getElementById('final-subtotal');
    if (sub2) sub2.innerText = `S/ ${sub.toFixed(2)}`;
    
